...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/01/17 16:44:57 by dong-hki          #+#    #+#             */
/*   Updated: 2025/01/17 16:44:57 by dong-hki         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool	op_on_same_stack(enum e_op ref, enum e_op to_check)
{
	...
	if (to_check == pa || to_check == pb || to_check == rr || to_check == rrr)
		return (true);
	else if (ref == ra || ref == rb || ref == rrr)
		return (to_check == ra || to_check == rra || to_check == rrr);
